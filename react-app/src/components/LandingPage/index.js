                ...
                {searchResults.length > 0 && (
                    <ul className="Search-Suggestions">
                        {searchResults.map((result) => (
                            <li key={result.id}>
                                <NavLink className="Redirect_ItemId" to={`/items/${result.id}`}>
                                    <img className="mainpic" src={result.mainimage} alt={result.name} />
                                    <p className="price-landing">${result.price}</p>
                                    {result.name}
                                </NavLink>
                            </li>
                        ))}
